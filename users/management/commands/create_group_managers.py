...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        permission_recipient = Permission.objects.get(
            codename="can_view_all_recipients", content_type=content_type_recipient
        )
        ...
        permission_message = Permission.objects.get(
            codename="can_view_all_messages", content_type=content_type_message
        )
        ...
        permission_mailing_view = Permission.objects.get(
            codename="can_view_all_mailings", content_type=content_type_mailing
        )
        permission_mailing_disable = Permission.objects.get(
            codename="can_disabling_mailing", content_type=content_type_mailing
        )

        # добавление права к группе
        group.permissions.add(
            permission_recipient, permission_message, permission_mailing_view, permission_mailing_disable
        )
