...
class Recipient(models.Model):
    ...
    fio = models.CharField(
        max_length=300, verbose_name="Ф.И.О.", help_text="Введите фамилию, имя, отчество", blank=True, null=True
    )
...
class Mailing(models.Model):
    ...
    name = models.CharField(
        max_length=150, verbose_name="Название рассылки", help_text="Введите название рассылки", blank=True, null=True
    )
    ...
    recipients = models.ManyToManyField(
        Recipient, verbose_name="Получатель", help_text="Укажите получателя", blank=True, null=True
    )
    owner = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
