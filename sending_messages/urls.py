...
from sending_messages.views import MailingTemplateView, SenderCreateView, MessageCreateView, \
    ...
    RecipientListMailingFormView, RecipientCreateView, MessageListView, MessageDeleteView, MessageDetailView
