...
from sending_messages.views import (AttemptMailingListView, InfoTemplateView, MailingDeleteView, MailingDetailView,
                                    MailingsActiveListView, MailingsListView, MailingTemplateView, MailingUpdateView,
                                    ...
                                    RecipientListFormView, RecipientListView, RecipientUpdateView, SendingCreateView,
                                    SendMailingView)
...
urlpatterns = [
    ...
    path("info/", InfoTemplateView.as_view(), name="info"),
